...
inspection, byte-identical synthesized bundle, and the full gate all pass.
...
- [ ] T008 [US1] Prove mock honesty, flake absence, image absence, and the byte-identical synthesized bundle using `specs/050-remove-dead-emitter/quickstart.md`
...
3. Independently verify bundle bytes and image contents before push.
